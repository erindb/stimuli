...
var Stimuli = {
  ...
  drawPaths: function(paper, pieces, colors, interpolationFunction, transparent) {
    for (var i = 0; i < pieces.length; i++) {
      ...
      if (transparent) {
        console.log("hi");
        drawnPath.attr({"opacityStops": "0.4-0.4-0.4"});
      }
    }
  },
