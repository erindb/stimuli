...
var Stimuli = {
  ...
  Bird: function() {
    ...
    function drawBody(paper, color, tail, gradColor, tailColor) {
      ...
      body.attr("fill", Stimuli.makeGradient("r",color));
      Stimuli.stroke(body);
      ...
      wing.attr("fill", Stimuli.makeGradient("0-", color));
      Stimuli.stroke(wing);
